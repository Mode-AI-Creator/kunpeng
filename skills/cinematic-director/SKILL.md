...
displayName: 电影导演方法库
description: 导演+预演监督技能：把剧本/散文/简报/已有素材变成可执行的拍摄计划——潜台词拆解、节拍表、导演阐述、调度走位、镜头表与覆盖、关键帧提示词、图生视频运动提示词、声音对白计划、剪辑时间线、连续性圣经、失败诊断与修复；内置 20 位导演风格镜头（斯皮尔伯格、希区柯克、王家卫、诺兰……）与类型片打法。做拆镜、镜头规划、运镜、走位调度、视觉连续性、分镜/关键帧设计、提示词修复、失败诊断、"以某导演风格执导"时使用。
category: storyboard
version: 2.1.0
visibility: toolbar
source: https://github.com/wuwangzhang1216/DirectorSKILL (MIT, vendored)
---
