...
displayName: Seedance 提示词工厂
description: 为即梦/Seedance 2.0 生成生产级中文视频与图片提示词：相机四维编码（Z/Y/X/F 精准运镜）、深度美学约束、长视频生产流水线（角色卡→分镜→逐镜头 25 格）、六套剪辑节奏公式、角色卡/首帧图/关键帧图生成。用户提到 Seedance、即梦、视频提示词、运镜、景别、机位、推拉摇移、剪辑节奏、图生视频、角色图、首帧图，或要求把图片做成视频时使用。
category: video
version: 3.1.0
visibility: toolbar
source: https://github.com/MapleShaw/seedance2.0-prompt-skill (MIT, vendored)
---
