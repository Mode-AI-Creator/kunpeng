...
- **汽车题材广告**：分镜与提示词必须叠加 car-commercial-storyboard 技能——按其「任务二」TVC 段落结构排镜（开场空镜→路跑段落→单主体细节特写→内饰→落点）、「任务三」车辆连续性规则（行驶方向锁定/越轴动机/反射随环境变化/动作因果接点）；车辆资产按其「任务一」的三视图+细节图复刻规范准备。
→ **给用户确认。**
